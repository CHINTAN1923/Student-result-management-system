                    ...
                    <div class="main-page" style="background-color: #1f2029">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #1f2029">
                                <div class="col-md-6">
                                    <h2 class="title" style="color: #c3c4ca">Manage Results</h2>
                                        ...
                                        <div class="panel" style="background-image: url(images/geometry.png)">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT  distinct tblstudents.StudentName,tblstudents.PRN,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tbldepartments.DeptName from tblresult join tblstudents on tblstudents.StudentId=tblresult.StudentId  join tbldepartments on tbldepartments.id=tblresult.DeptId";
