...
$mark=$_POST['marks'];
 ...
 $stmt = $dbh->prepare("SELECT tblsubjects.SubjectName,tblsubjects.id FROM tbldeptsubjectcomb join  tblsubjects on  tblsubjects.id=tbldeptsubjectcomb.SubjectId WHERE tbldeptsubjectcomb.DeptId=:did order by tblsubjects.SubjectName");
 $stmt->execute(array(':did' => $dept));
$sid1=array();
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {

array_push($sid1,$row['id']);//need to
   } 
  
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult(StudentId,DeptId,SubjectId,marks) VALUES(:studentid,:dept,:sid,:marks)";
                    ...
                    <div class="main-page" style="background-color: #1f2029">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #1f2029">
                                <div class="col-md-6" >
                                    <h2 class="title" style="color: #c3c4ca">Declare Result</h2>
...
<label for="default" class="col-sm-2 control-label" >Department</label>
 <div class="col-sm-10">
 <select name="dept" class="form-control clid" id="classid" onChange="getStudent(this.value);" required="required">
