...
<html lang="en">
    <head>
        ...
        <title>MSU Admin Update Subject </title>
                    ...
                    <div class="main-page" style="background-color: #1f2029">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #1f2029">
                                <div class="col-md-6">
                                    <h2 class="title" style="color: #c3c4ca ">Update Subject</h2>
...
{   ?>                                               
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label" style="color:black">Subject Name</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label" style="color:black">Subject Code</label>
                                                        <div class="col-sm-10">
