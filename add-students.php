...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,PRN,StudentEmail,Gender,DOB,DeptId,Status) VALUES(:studentname,:prn,:studentemail,:gender,:dob,:deptid,:status)";
                    ...
                    <div class="main-page"  style="background-color: #1f2029">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div"  style="background-color: #1f2029">
                                <div class="col-md-6">
                                    <h2 class="title" style="color: #c3c4ca">Student Admission</h2>
...
<div class="col-sm-10">
<input type="text" name="prn" class="form-control" id="rollid"  required="required" autocomplete="off">
</div>
</div>
