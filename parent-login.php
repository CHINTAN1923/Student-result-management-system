								...
								<div class="card-front">
									<div class="center-wrap">
										<div class="section text-center">
											<h4 class="mb-4 pb-3">Parents dashboard</h4>
											<div class="form-group">
												<input type="text" name = "prn" name="logemail" class="form-style" placeholder="Enter Your child's PRN" id="logemail" autocomplete="off">
...
<option value="" >Select his/her Department</option>
