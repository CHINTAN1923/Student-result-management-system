...
$status=1;
$sql="update tbldeptsubjectcomb set status=:status where id=:acid ";
...
$did=intval($_GET['did']);
$status=0;
$sql="update tbldeptsubjectcomb set status=:status where id=:did ";
$query = $dbh->prepare($sql);
                    ...
                    <div class="main-page" style="background-color: #1f2029">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #1f2029">
                                <div class="col-md-6">
                                    <h2 class="title" style="color: #c3c4ca">Manage Subjects Combination</h2>
                                        ...
                                        <div class="panel" style="background-image: url(images/geometry.png)">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tbldepartments.DeptName,tblsubjects.SubjectName,tbldeptsubjectcomb.id as scid , tbldeptsubjectcomb.status from tbldeptsubjectcomb join tbldepartments on tbldepartments.id=tbldeptsubjectcomb.DeptId  join tblsubjects on tblsubjects.id=tbldeptsubjectcomb.SubjectId";
$query = $dbh->prepare($sql);
$query->execute();
