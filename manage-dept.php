...
<html lang="en">
    <head>
        ...
        <title>MANAGE DEPARTMENT MSU</title>
                    ...
                    <div class="main-page" style="background-color: #1f2029">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #1f2029">
                                <div class="col-md-6">
                                    <h2 class="title" style="color: #c3c4ca">Manage Department</h2>
                            ...
                            <div class="row breadcrumb-div" style="background-color: #1f2029">
                                <div class="col-md-6">
                                    <ul class="breadcrumb" style="color: #c3c4ca">
                                        ...
                                        <li> Department</li>
            							<li class="active" style="color: #c3c4ca">Manage Department</li>
            						</ul>
                                </div>
...
<td>
<a href="edit-dept.php?id=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
